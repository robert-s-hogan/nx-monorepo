  ...
  const FeatherDivideSquareIcon = (props: CommonProps) => {
    const svgClassNames = ['font-awesome', 'feather-divide-square'];
    ...
    return (
      <svg
        ...
        className={`feather feather-divide-square ${combinedClassNames}`}
        {...props}
      >
  ...
  export default IconWrapper(FeatherDivideSquareIcon);
