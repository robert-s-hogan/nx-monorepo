...
const FeatherMoveIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'feathermove'];
  ...
  return (
    <svg
      ...
      className={`feather feather-feathermove ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FeatherMove = IconWrapper(FeatherMoveIcon);
