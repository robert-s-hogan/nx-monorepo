...
const FaHashnodeIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'hashnode'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa hashnode ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaHashnodeIcon);
