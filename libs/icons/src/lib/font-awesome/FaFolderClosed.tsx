...
const FaFolderClosedIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-folderclosed'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      viewBox="0 0 512 512"
      className={`fa fa-folderclosed ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaFolderClosed = IconWrapper(FaFolderClosedIcon);
