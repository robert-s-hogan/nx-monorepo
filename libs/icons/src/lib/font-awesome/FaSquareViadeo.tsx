...
const FaSquareViadeoIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'squareviadeo'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa squareviadeo ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaSquareViadeoIcon);
