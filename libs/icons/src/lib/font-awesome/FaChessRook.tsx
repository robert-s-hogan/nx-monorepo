...
const FaChessRookIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-chessrook'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      viewBox="0 0 448 512"
      className={`fa fa-chessrook ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaChessRook = IconWrapper(FaChessRookIcon);
