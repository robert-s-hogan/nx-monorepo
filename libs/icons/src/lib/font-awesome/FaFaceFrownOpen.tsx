...
const FaFaceFrownOpenIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-facefrownopen'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa fa-facefrownopen ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaFaceFrownOpen = IconWrapper(FaFaceFrownOpenIcon);
