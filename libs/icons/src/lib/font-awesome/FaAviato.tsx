...
const FaAviatoIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'aviato'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 640 512"
      className={`fa aviato ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaAviatoIcon);
