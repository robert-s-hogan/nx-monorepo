...
const FaPhoenixFrameworkIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'phoenixframework'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 640 512"
      className={`fa phoenixframework ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaPhoenixFrameworkIcon);
