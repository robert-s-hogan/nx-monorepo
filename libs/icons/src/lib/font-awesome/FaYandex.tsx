...
const FaYandexIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'yandex'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 256 512"
      className={`fa yandex ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaYandexIcon);
