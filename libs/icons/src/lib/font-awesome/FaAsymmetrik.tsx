...
const FaAsymmetrikIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'asymmetrik'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 576 512"
      className={`fa asymmetrik ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaAsymmetrikIcon);
