...
const FaStumbleuponIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'stumbleupon'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa stumbleupon ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaStumbleuponIcon);
