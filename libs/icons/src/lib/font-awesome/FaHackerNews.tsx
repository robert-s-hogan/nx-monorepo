...
const FaHackerNewsIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'hackernews'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa hackernews ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaHackerNewsIcon);
