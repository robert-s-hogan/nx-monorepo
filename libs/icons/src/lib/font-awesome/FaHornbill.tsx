...
const FaHornbillIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'hornbill'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa hornbill ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaHornbillIcon);
