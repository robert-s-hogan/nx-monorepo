...
const FaAppStoreIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'appstore'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa appstore ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaAppStoreIcon);
