...
const FaAngularIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'angular'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa angular ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaAngularIcon);
