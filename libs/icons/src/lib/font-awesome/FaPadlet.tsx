...
const FaPadletIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'padlet'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 640 512"
      className={`fa padlet ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaPadletIcon);
