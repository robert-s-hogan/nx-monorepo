...
const FaGalacticRepublicIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'galacticrepublic'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 496 512"
      className={`fa galacticrepublic ${combinedClassNames}`}
      {...props}
    >
...
export default DynamicIconWrapper(() =>
  Promise.resolve({ default: FaGalacticRepublicIcon })
);
