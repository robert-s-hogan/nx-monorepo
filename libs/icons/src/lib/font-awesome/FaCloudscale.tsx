...
const FaCloudscaleIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'cloudscale'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa cloudscale ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaCloudscaleIcon);
