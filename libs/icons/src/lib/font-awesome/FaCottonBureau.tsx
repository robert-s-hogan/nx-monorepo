...
const FaCottonBureauIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'cottonbureau'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa cottonbureau ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaCottonBureauIcon);
