...
const FaSquareThreadsIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'squarethreads'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa squarethreads ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaSquareThreadsIcon);
