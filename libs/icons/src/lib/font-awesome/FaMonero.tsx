...
const FaMoneroIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'monero'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 496 512"
      className={`fa monero ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaMoneroIcon);
