...
const FaUnchartedIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'uncharted'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa uncharted ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaUnchartedIcon);
