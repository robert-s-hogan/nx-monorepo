...
const FaEdgeLegacyIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'edgelegacy'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa edgelegacy ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaEdgeLegacyIcon);
