...
const FaPeriscopeIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'periscope'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa periscope ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaPeriscopeIcon);
