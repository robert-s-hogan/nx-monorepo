...
const FaReadmeIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'readme'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 576 512"
      className={`fa readme ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaReadmeIcon);
