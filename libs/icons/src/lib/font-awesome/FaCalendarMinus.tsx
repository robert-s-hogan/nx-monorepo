...
const FaCalendarMinusIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-calendarminus'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa fa-calendarminus ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaCalendarMinus = IconWrapper(FaCalendarMinusIcon);
