...
const FaMicroblogIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'microblog'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa microblog ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaMicroblogIcon);
