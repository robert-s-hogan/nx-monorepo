...
const FaPhabricatorIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'phabricator'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 496 512"
      className={`fa phabricator ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaPhabricatorIcon);
