...
const FaFileZipperIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-filezipper'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 384 512"
      className={`fa fa-filezipper ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaFileZipper = IconWrapper(FaFileZipperIcon);
