...
const FaCirclePauseIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-circlepause'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      viewBox="0 0 512 512"
      className={`fa fa-circlepause ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaCirclePause = IconWrapper(FaCirclePauseIcon);
