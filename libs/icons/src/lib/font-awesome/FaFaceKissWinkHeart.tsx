...
const FaFaceKissWinkHeartIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'facekisswinkheart'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa facekisswinkheart ${combinedClassNames}`}
      {...props}
    >
...
export default DynamicIconWrapper(() =>
  Promise.resolve({ default: FaFaceKissWinkHeartIcon })
);
