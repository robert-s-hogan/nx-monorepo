...
const FaFaceKissWinkHeartIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-facekisswinkheart'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa fa-facekisswinkheart ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaFaceKissWinkHeart = IconWrapper(FaFaceKissWinkHeartIcon);
