...
const FaFileVideoIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-filevideo'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 384 512"
      className={`fa fa-filevideo ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaFileVideo = IconWrapper(FaFileVideoIcon);
