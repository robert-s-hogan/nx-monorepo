...
const FaTradeFederationIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'tradefederation'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 496 512"
      className={`fa tradefederation ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaTradeFederationIcon);
