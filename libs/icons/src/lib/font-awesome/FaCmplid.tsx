...
const FaCmplidIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'cmplid'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 640 512"
      className={`fa cmplid ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaCmplidIcon);
