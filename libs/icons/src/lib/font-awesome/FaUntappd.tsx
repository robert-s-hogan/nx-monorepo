...
const FaUntappdIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'untappd'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 640 512"
      className={`fa untappd ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaUntappdIcon);
