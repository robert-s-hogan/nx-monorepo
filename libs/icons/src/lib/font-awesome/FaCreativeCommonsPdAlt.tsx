...
const FaCreativeCommonsPdAltIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'creativecommonspdalt'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 496 512"
      className={`fa creativecommonspdalt ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaCreativeCommonsPdAltIcon);
