...
const FaDrupalIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'drupal'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa drupal ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaDrupalIcon);
