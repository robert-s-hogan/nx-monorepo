...
const FaAlgoliaIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'algolia'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa algolia ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaAlgoliaIcon);
