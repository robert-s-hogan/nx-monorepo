...
const FaKeybaseIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'keybase'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa keybase ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaKeybaseIcon);
