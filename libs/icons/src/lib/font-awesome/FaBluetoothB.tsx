...
const FaBluetoothBIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'bluetoothb'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 320 512"
      className={`fa bluetoothb ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaBluetoothBIcon);
