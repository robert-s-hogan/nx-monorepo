...
const FaRectangleListIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-rectanglelist'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 576 512"
      className={`fa fa-rectanglelist ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaRectangleList = IconWrapper(FaRectangleListIcon);
