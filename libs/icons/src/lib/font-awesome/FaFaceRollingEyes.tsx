...
const FaFaceRollingEyesIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-facerollingeyes'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      viewBox="0 0 512 512"
      className={`fa fa-facerollingeyes ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaFaceRollingEyes = IconWrapper(FaFaceRollingEyesIcon);
