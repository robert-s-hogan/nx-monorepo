...
const FaLeanpubIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'leanpub'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 576 512"
      className={`fa leanpub ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaLeanpubIcon);
