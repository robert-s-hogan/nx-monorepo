...
const FaFaceGrinBeamSweatIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-facegrinbeamsweat'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa fa-facegrinbeamsweat ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaFaceGrinBeamSweat = IconWrapper(FaFaceGrinBeamSweatIcon);
