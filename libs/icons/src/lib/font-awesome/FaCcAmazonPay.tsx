...
const FaCcAmazonPayIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'ccamazonpay'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 576 512"
      className={`fa ccamazonpay ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaCcAmazonPayIcon);
