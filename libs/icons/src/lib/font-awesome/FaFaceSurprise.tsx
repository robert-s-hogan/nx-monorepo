...
const FaFaceSurpriseIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-facesurprise'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      viewBox="0 0 512 512"
      className={`fa fa-facesurprise ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaFaceSurprise = IconWrapper(FaFaceSurpriseIcon);
