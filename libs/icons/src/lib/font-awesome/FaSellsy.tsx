...
const FaSellsyIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'sellsy'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 640 512"
      className={`fa sellsy ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaSellsyIcon);
