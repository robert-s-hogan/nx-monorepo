...
const FaNoteStickyIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-notesticky'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa fa-notesticky ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaNoteSticky = IconWrapper(FaNoteStickyIcon);
