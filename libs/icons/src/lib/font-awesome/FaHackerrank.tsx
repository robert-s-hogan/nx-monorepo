...
const FaHackerrankIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'hackerrank'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa hackerrank ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaHackerrankIcon);
