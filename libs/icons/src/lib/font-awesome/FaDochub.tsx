...
const FaDochubIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'dochub'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 416 512"
      className={`fa dochub ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaDochubIcon);
