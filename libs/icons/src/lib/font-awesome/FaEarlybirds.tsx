...
const FaEarlybirdsIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'earlybirds'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 480 512"
      className={`fa earlybirds ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaEarlybirdsIcon);
