...
const FaSpeakerDeckIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'speakerdeck'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa speakerdeck ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaSpeakerDeckIcon);
