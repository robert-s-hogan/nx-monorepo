...
const FaProductHuntIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'producthunt'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa producthunt ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaProductHuntIcon);
