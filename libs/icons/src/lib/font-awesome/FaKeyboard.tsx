...
const FaKeyboardIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-keyboard'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 576 512"
      className={`fa fa-keyboard ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaKeyboard = IconWrapper(FaKeyboardIcon);
