...
const FaUssunnahIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'ussunnah'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 482 512"
      className={`fa ussunnah ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaUssunnahIcon);
