...
const FaFonticonsIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fonticons'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa fonticons ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaFonticonsIcon);
