...
const FaReplydIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'replyd'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa replyd ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaReplydIcon);
