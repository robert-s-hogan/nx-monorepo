...
const FaLastfmIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'lastfm'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa lastfm ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaLastfmIcon);
