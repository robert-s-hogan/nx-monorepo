...
const FaDiscourseIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'discourse'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa discourse ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaDiscourseIcon);
