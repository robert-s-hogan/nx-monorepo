...
const FaLinodeIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'linode'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa linode ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaLinodeIcon);
