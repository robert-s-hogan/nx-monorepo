...
const FaFaceLaughIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-facelaugh'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      viewBox="0 0 512 512"
      className={`fa fa-facelaugh ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaFaceLaugh = IconWrapper(FaFaceLaughIcon);
