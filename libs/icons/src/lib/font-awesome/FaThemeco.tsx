...
const FaThemecoIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'themeco'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa themeco ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaThemecoIcon);
