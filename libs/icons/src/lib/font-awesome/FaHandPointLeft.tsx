...
const FaHandPointLeftIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-handpointleft'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      viewBox="0 0 512 512"
      className={`fa fa-handpointleft ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaHandPointLeft = IconWrapper(FaHandPointLeftIcon);
