...
const FaFortAwesomeIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fortawesome'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa fortawesome ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaFortAwesomeIcon);
