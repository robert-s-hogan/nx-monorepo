...
const FaPatreonIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'patreon'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa patreon ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaPatreonIcon);
