...
const FaRockrmsIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'rockrms'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 496 512"
      className={`fa rockrms ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaRockrmsIcon);
