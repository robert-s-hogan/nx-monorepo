...
const FaSellcastIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'sellcast'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa sellcast ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaSellcastIcon);
