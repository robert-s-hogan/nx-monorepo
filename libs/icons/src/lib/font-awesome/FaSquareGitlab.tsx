...
const FaSquareGitlabIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'squaregitlab'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa squaregitlab ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaSquareGitlabIcon);
