...
const FaKaggleIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'kaggle'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 320 512"
      className={`fa kaggle ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaKaggleIcon);
