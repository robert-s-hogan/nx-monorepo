...
const FaHandScissorsIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-handscissors'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa fa-handscissors ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaHandScissors = IconWrapper(FaHandScissorsIcon);
