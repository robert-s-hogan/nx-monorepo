...
const FaBlackberryIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'blackberry'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa blackberry ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaBlackberryIcon);
