...
const FaChessQueenIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-chessqueen'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      viewBox="0 0 512 512"
      className={`fa fa-chessqueen ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaChessQueen = IconWrapper(FaChessQueenIcon);
