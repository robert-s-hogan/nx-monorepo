...
const FaWatchmanMonitoringIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'watchmanmonitoring'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa watchmanmonitoring ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaWatchmanMonitoringIcon);
