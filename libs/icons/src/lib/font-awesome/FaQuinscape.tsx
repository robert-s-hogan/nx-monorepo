...
const FaQuinscapeIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'quinscape'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa quinscape ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaQuinscapeIcon);
