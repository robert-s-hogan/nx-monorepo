...
const FaStackOverflowIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'stackoverflow'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 384 512"
      className={`fa stackoverflow ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaStackOverflowIcon);
