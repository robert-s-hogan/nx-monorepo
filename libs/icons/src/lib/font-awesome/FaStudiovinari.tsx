...
const FaStudiovinariIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'studiovinari'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa studiovinari ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaStudiovinariIcon);
