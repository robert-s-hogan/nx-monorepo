...
const FaLemonIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-lemon'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa fa-lemon ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaLemon = IconWrapper(FaLemonIcon);
