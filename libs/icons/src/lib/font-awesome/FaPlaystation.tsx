...
const FaPlaystationIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'playstation'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 576 512"
      className={`fa playstation ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaPlaystationIcon);
