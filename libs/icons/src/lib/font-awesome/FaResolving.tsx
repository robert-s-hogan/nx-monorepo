...
const FaResolvingIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'resolving'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 496 512"
      className={`fa resolving ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaResolvingIcon);
