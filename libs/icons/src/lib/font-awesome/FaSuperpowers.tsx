...
const FaSuperpowersIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'superpowers'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa superpowers ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaSuperpowersIcon);
