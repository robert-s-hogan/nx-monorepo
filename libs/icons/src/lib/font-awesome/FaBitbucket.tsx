...
const FaBitbucketIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'bitbucket'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa bitbucket ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaBitbucketIcon);
