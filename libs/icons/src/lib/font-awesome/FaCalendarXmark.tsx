...
const FaCalendarXmarkIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-calendarxmark'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      viewBox="0 0 512 512"
      className={`fa fa-calendarxmark ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaCalendarXmark = IconWrapper(FaCalendarXmarkIcon);
