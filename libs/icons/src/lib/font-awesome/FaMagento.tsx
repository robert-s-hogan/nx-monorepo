...
const FaMagentoIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'magento'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa magento ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaMagentoIcon);
