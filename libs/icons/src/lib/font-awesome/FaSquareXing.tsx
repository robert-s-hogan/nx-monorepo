...
const FaSquareXingIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'squarexing'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa squarexing ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaSquareXingIcon);
