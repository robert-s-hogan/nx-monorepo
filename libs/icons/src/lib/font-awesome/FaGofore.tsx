...
const FaGoforeIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'gofore'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 400 512"
      className={`fa gofore ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaGoforeIcon);
