...
const FaSquareHackerNewsIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'squarehackernews'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa squarehackernews ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaSquareHackerNewsIcon);
