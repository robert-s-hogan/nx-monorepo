...
const FaFileExcelIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-fileexcel'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 384 512"
      className={`fa fa-fileexcel ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaFileExcel = IconWrapper(FaFileExcelIcon);
