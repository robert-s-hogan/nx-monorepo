...
const FaBimobjectIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'bimobject'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa bimobject ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaBimobjectIcon);
