...
const FaChessKnightIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-chessknight'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa fa-chessknight ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaChessKnight = IconWrapper(FaChessKnightIcon);
