...
const FaArtstationIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'artstation'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa artstation ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaArtstationIcon);
