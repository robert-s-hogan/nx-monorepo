...
const FaSquareLastfmIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'squarelastfm'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa squarelastfm ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaSquareLastfmIcon);
