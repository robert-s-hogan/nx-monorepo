...
const FaFaceSadTearIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-facesadtear'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa fa-facesadtear ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaFaceSadTear = IconWrapper(FaFaceSadTearIcon);
