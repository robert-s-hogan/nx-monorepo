...
const FaStickerMuleIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'stickermule'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 576 512"
      className={`fa stickermule ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaStickerMuleIcon);
