...
const FaSquareJsIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'squarejs'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa squarejs ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaSquareJsIcon);
