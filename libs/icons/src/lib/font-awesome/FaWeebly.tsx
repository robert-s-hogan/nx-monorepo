...
const FaWeeblyIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'weebly'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa weebly ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaWeeblyIcon);
