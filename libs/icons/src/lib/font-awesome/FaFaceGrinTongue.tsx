...
const FaFaceGrinTongueIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-facegrintongue'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa fa-facegrintongue ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaFaceGrinTongue = IconWrapper(FaFaceGrinTongueIcon);
