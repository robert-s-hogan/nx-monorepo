...
const FaSquarePiedPiperIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'squarepiedpiper'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa squarepiedpiper ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaSquarePiedPiperIcon);
