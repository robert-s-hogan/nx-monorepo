...
const FaCcAmexIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'ccamex'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 576 512"
      className={`fa ccamex ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaCcAmexIcon);
