...
const FaAirbnbIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'airbnb'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa airbnb ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaAirbnbIcon);
