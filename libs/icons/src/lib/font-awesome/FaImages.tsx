...
const FaImagesIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-images'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 576 512"
      className={`fa fa-images ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaImages = IconWrapper(FaImagesIcon);
