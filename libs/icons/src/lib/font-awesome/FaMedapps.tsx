...
const FaMedappsIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'medapps'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 320 512"
      className={`fa medapps ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaMedappsIcon);
