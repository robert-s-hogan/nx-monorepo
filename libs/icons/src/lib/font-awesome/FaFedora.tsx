...
const FaFedoraIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fedora'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa fedora ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaFedoraIcon);
