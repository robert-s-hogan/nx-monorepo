...
const FaPiedPiperHatIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'piedpiperhat'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 640 512"
      className={`fa piedpiperhat ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaPiedPiperHatIcon);
