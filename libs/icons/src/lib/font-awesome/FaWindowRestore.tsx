...
const FaWindowRestoreIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-windowrestore'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      viewBox="0 0 512 512"
      className={`fa fa-windowrestore ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaWindowRestore = IconWrapper(FaWindowRestoreIcon);
