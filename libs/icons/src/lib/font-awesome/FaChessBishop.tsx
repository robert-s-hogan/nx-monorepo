...
const FaChessBishopIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-chessbishop'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 320 512"
      viewBox="0 0 320 512"
      className={`fa fa-chessbishop ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaChessBishop = IconWrapper(FaChessBishopIcon);
