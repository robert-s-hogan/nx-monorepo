...
const FaHourglassHalfIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-hourglasshalf'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 384 512"
      viewBox="0 0 384 512"
      className={`fa fa-hourglasshalf ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaHourglassHalf = IconWrapper(FaHourglassHalfIcon);
