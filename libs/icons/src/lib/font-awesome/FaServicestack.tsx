...
const FaServicestackIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'servicestack'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 496 512"
      className={`fa servicestack ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaServicestackIcon);
