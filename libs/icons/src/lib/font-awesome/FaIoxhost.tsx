...
const FaIoxhostIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'ioxhost'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 640 512"
      className={`fa ioxhost ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaIoxhostIcon);
