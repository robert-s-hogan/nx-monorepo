...
const FaYammerIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'yammer'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa yammer ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaYammerIcon);
