...
const FaHandshakeIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'fa-handshake'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 640 512"
      className={`fa fa-handshake ${combinedClassNames}`}
      {...otherProps}
    >
...
export const FaHandshake = IconWrapper(FaHandshakeIcon);
