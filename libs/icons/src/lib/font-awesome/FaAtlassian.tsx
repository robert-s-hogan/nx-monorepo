...
const FaAtlassianIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'atlassian'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa atlassian ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaAtlassianIcon);
