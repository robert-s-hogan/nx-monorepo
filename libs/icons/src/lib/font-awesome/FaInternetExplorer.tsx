...
const FaInternetExplorerIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'internetexplorer'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      className={`fa internetexplorer ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaInternetExplorerIcon);
