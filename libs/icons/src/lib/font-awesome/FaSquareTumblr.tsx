...
const FaSquareTumblrIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'squaretumblr'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 448 512"
      className={`fa squaretumblr ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaSquareTumblrIcon);
