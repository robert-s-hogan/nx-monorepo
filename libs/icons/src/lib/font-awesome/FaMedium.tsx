...
const FaMediumIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'medium'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 640 512"
      className={`fa medium ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaMediumIcon);
