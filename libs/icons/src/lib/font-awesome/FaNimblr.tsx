...
const FaNimblrIcon = (props: CommonProps) => {
  const svgClassNames = ['font-awesome', 'nimblr'];
  ...
  return (
    <svg
      ...
      viewBox="0 0 384 512"
      className={`fa nimblr ${combinedClassNames}`}
      {...props}
    >
...
export default IconWrapper(FaNimblrIcon);
