...
const UserXIcon = (props: CommonProps) => {
  return (
    <svg
      ...
      className={`feather feather-user-x ${props.className}`}
      {...props}
    >
      ...
      <path d="M17.88 14.121L14.121 17.88M17.88 17.8799L14.121 14.1209" />
...
export const UserX = IconWrapper(UserXIcon);
