  ...
  const GameIconEarthAfricaEuropeIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'earth-africa-europe'];
  ...
  export default IconWrapper(GameIconEarthAfricaEuropeIcon);
