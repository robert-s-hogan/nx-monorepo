...
const GameIconEarthAsiaOceaniaIcon = (props: CommonProps) => {
  const svgClassNames = ['game-icon', 'earth-asia-oceania'];
...
export default DynamicIconWrapper(() =>
  Promise.resolve({ default: GameIconEarthAsiaOceaniaIcon })
);
