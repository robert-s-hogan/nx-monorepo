  ...
  const GameIconStaplerPneumaticIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'stapler-pneumatic'];
  ...
  export default IconWrapper(GameIconStaplerPneumaticIcon);
