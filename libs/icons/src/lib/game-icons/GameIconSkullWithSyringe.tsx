  ...
  const GameIconSkullWithSyringeIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'skull-with-syringe'];
  ...
  export default IconWrapper(GameIconSkullWithSyringeIcon);
