  ...
  const GameIconVikingLonghouseIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'viking-longhouse'];
  ...
  export default IconWrapper(GameIconVikingLonghouseIcon);
