  ...
  const GameIconFeatherNecklaceIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'feather-necklace'];
  ...
  export default IconWrapper(GameIconFeatherNecklaceIcon);
