  ...
  const GameIconCaptainHatProfileIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'captain-hat-profile'];
  ...
  export default IconWrapper(GameIconCaptainHatProfileIcon);
