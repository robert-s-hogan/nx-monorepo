  ...
  const GameIconClaymoreExplosiveIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'claymore-explosive'];
  ...
  export default IconWrapper(GameIconClaymoreExplosiveIcon);
