  ...
  const GameIconLargePaintBrushIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'large-paint-brush'];
  ...
  export default IconWrapper(GameIconLargePaintBrushIcon);
