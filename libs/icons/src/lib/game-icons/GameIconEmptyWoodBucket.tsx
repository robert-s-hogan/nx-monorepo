  ...
  const GameIconEmptyWoodBucketIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'empty-wood-bucket'];
  ...
  export default IconWrapper(GameIconEmptyWoodBucketIcon);
