  ...
  const GameIconEclipseIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'eclipse'];
  ...
  export default IconWrapper(GameIconEclipseIcon);
