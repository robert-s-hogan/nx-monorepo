  ...
  const GameIconHearingDisabledIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'hearing-disabled'];
  ...
  export default IconWrapper(GameIconHearingDisabledIcon);
