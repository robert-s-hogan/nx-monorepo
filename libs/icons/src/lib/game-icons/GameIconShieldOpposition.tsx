  ...
  const GameIconShieldOppositionIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'shield-opposition'];
  ...
  export default IconWrapper(GameIconShieldOppositionIcon);
