  ...
  const GameIconPerspectiveDiceSixFacesOneIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'perspective-dice-six-faces-one'];
  ...
  export default IconWrapper(GameIconPerspectiveDiceSixFacesOneIcon);
