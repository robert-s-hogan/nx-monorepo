  ...
  const GameIconConsoleControllerIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'console-controller'];
  ...
  export default IconWrapper(GameIconConsoleControllerIcon);
