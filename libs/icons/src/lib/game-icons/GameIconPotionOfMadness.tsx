  ...
  const GameIconPotionOfMadnessIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'potion-of-madness'];
  ...
  export default IconWrapper(GameIconPotionOfMadnessIcon);
