  ...
  const GameIconRadarCrossSectionIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'radar-cross-section'];
  ...
  export default IconWrapper(GameIconRadarCrossSectionIcon);
