  ...
  const GameIconHypersonicMelonIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'hypersonic-melon'];
  ...
  export default IconWrapper(GameIconHypersonicMelonIcon);
