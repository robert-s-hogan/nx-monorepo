  ...
  const GameIconAztecCalendarSunIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'aztec-calendar-sun'];
  ...
  export default IconWrapper(GameIconAztecCalendarSunIcon);
