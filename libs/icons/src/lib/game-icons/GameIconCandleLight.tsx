  ...
  const GameIconCandleLightIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'candle-light'];
  ...
  export default IconWrapper(GameIconCandleLightIcon);
