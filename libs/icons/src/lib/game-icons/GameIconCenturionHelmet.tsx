  ...
  const GameIconCenturionHelmetIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'centurion-helmet'];
  ...
  export default IconWrapper(GameIconCenturionHelmetIcon);
