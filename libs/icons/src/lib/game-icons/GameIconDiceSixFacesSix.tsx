  ...
  const GameIconDiceSixFacesSixIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'dice-six-faces-six'];
  ...
  export default IconWrapper(GameIconDiceSixFacesSixIcon);
