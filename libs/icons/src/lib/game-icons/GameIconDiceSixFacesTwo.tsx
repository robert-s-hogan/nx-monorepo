...
const GameIconDiceSixFacesTwoIcon = (props: CommonProps) => {
  const svgClassNames = ['game-icon', 'dice-six-faces-two'];
...
export default DynamicIconWrapper(() =>
  Promise.resolve({ default: GameIconDiceSixFacesTwoIcon })
);
