  ...
  const GameIconAnticlockwiseRotationIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'anticlockwise-rotation'];
  ...
  export default IconWrapper(GameIconAnticlockwiseRotationIcon);
