  ...
  const GameIconDiceSixFacesFourIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'dice-six-faces-four'];
  ...
  export default IconWrapper(GameIconDiceSixFacesFourIcon);
