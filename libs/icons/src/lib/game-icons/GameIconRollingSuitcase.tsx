  ...
  const GameIconRollingSuitcaseIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'rolling-suitcase'];
  ...
  export default IconWrapper(GameIconRollingSuitcaseIcon);
