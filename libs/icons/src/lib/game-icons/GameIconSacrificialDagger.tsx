  ...
  const GameIconSacrificialDaggerIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'sacrificial-dagger'];
  ...
  export default IconWrapper(GameIconSacrificialDaggerIcon);
