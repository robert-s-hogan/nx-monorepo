...
const GameIconBasketballJerseyIcon = (props: CommonProps) => {
  const svgClassNames = ['game-icon', 'basketball-jersey'];
...
export default DynamicIconWrapper(() =>
  Promise.resolve({ default: GameIconBasketballJerseyIcon })
);
