  ...
  const GameIconEgyptianProfileIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'egyptian-profile'];
  ...
  export default IconWrapper(GameIconEgyptianProfileIcon);
