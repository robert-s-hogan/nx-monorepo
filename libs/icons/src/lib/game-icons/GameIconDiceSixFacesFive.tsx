  ...
  const GameIconDiceSixFacesFiveIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'dice-six-faces-five'];
  ...
  export default IconWrapper(GameIconDiceSixFacesFiveIcon);
