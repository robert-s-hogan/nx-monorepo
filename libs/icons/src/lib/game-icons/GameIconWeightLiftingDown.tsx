  ...
  const GameIconWeightLiftingDownIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'weight-lifting-down'];
  ...
  export default IconWrapper(GameIconWeightLiftingDownIcon);
