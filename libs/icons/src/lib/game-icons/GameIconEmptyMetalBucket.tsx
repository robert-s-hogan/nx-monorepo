  ...
  const GameIconEmptyMetalBucketIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'empty-metal-bucket'];
  ...
  export default IconWrapper(GameIconEmptyMetalBucketIcon);
