...
const GameIconCardJackDiamondsIcon = (props: CommonProps) => {
  const svgClassNames = ['game-icon', 'card-jack-diamonds'];
...
export default DynamicIconWrapper(() =>
  Promise.resolve({ default: GameIconCardJackDiamondsIcon })
);
