  ...
  const GameIconBassetHoundHeadIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'basset-hound-head'];
  ...
  export default IconWrapper(GameIconBassetHoundHeadIcon);
