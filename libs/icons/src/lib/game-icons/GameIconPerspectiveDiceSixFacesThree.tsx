  ...
  const GameIconPerspectiveDiceSixFacesThreeIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'perspective-dice-six-faces-three'];
  ...
  export default IconWrapper(GameIconPerspectiveDiceSixFacesThreeIcon);
