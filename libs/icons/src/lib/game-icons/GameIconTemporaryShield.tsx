  ...
  const GameIconTemporaryShieldIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'temporary-shield'];
  ...
  export default IconWrapper(GameIconTemporaryShieldIcon);
