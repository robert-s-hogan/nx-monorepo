...
const GameIconEmptyWoodBucketHandleIcon = (props: CommonProps) => {
  const svgClassNames = ['game-icon', 'empty-wood-bucket-handle'];
...
export default DynamicIconWrapper(() =>
  Promise.resolve({ default: GameIconEmptyWoodBucketHandleIcon })
);
