...
const GameIconVelociraptorTracksIcon = (props: CommonProps) => {
  const svgClassNames = ['game-icon', 'velociraptor-tracks'];
...
export default DynamicIconWrapper(() =>
  Promise.resolve({ default: GameIconVelociraptorTracksIcon })
);
