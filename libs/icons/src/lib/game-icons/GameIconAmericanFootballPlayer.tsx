  ...
  const GameIconAmericanFootballPlayerIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'american-football-player'];
  ...
  export default IconWrapper(GameIconAmericanFootballPlayerIcon);
