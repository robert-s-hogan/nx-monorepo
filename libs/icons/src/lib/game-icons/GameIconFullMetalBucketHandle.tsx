  ...
  const GameIconFullMetalBucketHandleIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'full-metal-bucket-handle'];
  ...
  export default IconWrapper(GameIconFullMetalBucketHandleIcon);
