  ...
  const GameIconGardeningShearsIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'gardening-shears'];
  ...
  export default IconWrapper(GameIconGardeningShearsIcon);
