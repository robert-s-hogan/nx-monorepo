  ...
  const GameIconBowlingPropulsionIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'bowling-propulsion'];
  ...
  export default IconWrapper(GameIconBowlingPropulsionIcon);
