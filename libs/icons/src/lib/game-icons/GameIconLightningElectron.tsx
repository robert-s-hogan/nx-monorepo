...
const GameIconLightningElectronIcon = (props: CommonProps) => {
  const svgClassNames = ['game-icon', 'lightning-electron'];
...
export default DynamicIconWrapper(() =>
  Promise.resolve({ default: GameIconLightningElectronIcon })
);
