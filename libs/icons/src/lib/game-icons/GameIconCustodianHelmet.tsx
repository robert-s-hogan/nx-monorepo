  ...
  const GameIconCustodianHelmetIcon = (props: CommonProps) => {
    const svgClassNames = ['game-icon', 'custodian-helmet'];
  ...
  export default IconWrapper(GameIconCustodianHelmetIcon);
