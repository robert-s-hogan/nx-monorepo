...
import { Race } from '@with-nx/types';
...
export const races: Race[] = [
  ...
  },
  {
    name: 'Gnome',
    description:
      'A gnomes energy and enthusiasm for living shines through every inch of his or her tiny body.',
    rarity: rarities[2],
    subraces: [
      {
        name: 'Forest Gnome',
  ...
  },
  {
    name: 'Goliath',
    description:
      'Goliaths are giant humanoids from wild, remote regions. They are known for their physical prowess and competitive nature.',
    rarity: rarities[3],
