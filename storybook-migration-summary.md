...
- `pnpm dlx storybook automigrate --config-dir libs/icons/.storybook`

- `pnpm dlx storybook automigrate --config-dir libs/react-hooks/.storybook`

- `pnpm dlx storybook automigrate --config-dir libs/react-ui/.storybook`
