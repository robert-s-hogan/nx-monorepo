  ...
  return (
    <ChilloutLayout>
      <div className="w-full relative">
        <Flex className="h-screen flex-col justify-center items-center text-center text-white px:2 lg:px-6 space-y-10">
            ...
            <div className="flex flex-col lg:mx-8 lg:flex-row">
              <div className="w-full mt-8 lg:mt-0">
                ...
                <p className="text-gray-600 leading-loose mb-6">
                  ...
                  Adipiscing pretium ultrices non vel molestie et cras
                  venenatis. Urna aliquam a diam venenatis vel. Nulla tristique
                  mauris purus, pharetra etiam sagittis, aenean ultrices.
                  Lacinia proin pharetra venenatis nisl dictum sit fames cursus
                  accumsan.
                </p>
                <p className="text-gray-600 leading-loose mb-6">
                ...
                <p className="text-gray-600 leading-loose mb-6">
                  ...
                  Semper non quis quis nam. Eget lectus vitae dignissim
                  phasellus sit lectus in orci sed.
                </p>
                <p className="text-gray-600 leading-loose mb-6">
                  Felis, elementum in convallis aliquam quis. Commodo ac purus
                  semper viverra proin etiam erat fermentum volutpat. Molestie
                  curabitur libero pharetra lectus in. Orci erat in amet
                  interdum morbi. Diam urna ultrices nulla lacus, quis risus.
                </p>
              </div>
