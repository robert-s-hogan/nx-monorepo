const Scene = () => {
  return (
    ...
    >
      ...
      <path
        style={{ fill: '#FECB69' }}
        d="M256,190.962v166.054l143.752-66.422C384.604,241.195,326.625,190.962,256,190.962z"
      />
      <path
        style={{ fill: '#FFE0A2' }}
        d="M256,190.962c-70.625,0-128.604,50.232-143.752,99.632L256,357.016l99.471-66.422
	C344.989,241.195,304.87,190.962,256,190.962z"
      />
      <path
        style={{ fill: '#4B8D8F' }}
        d="M507.849,260.151c-9.07,18.676-28.215,31.55-50.37,31.55l-33.211,110.149L457.479,512h50.37V260.151z
	"
      />
      <path
        style={{ fill: '#63ABA1' }}
        d="M407.109,260.151c-9.069,18.674-28.215,31.55-50.37,31.55s-41.301-12.876-50.37-31.55
	...
	C435.324,291.702,416.178,278.826,407.109,260.151z"
      ...
      <g>
        <path
          style={{ fill: '#FFFFFF' }}
          d="M163.563,366.426h-16.605c-4.586,0-8.303-3.716-8.303-8.303c0-4.586,3.716-8.303,8.303-8.303h16.605
		c4.586,0,8.303,3.716,8.303,8.303C171.866,362.71,168.15,366.426,163.563,366.426z"
        />
        <path
          style={{ fill: '#FFFFFF' }}
          d="M415.412,466.058h-16.605c-4.586,0-8.303-3.716-8.303-8.303c0-4.586,3.716-8.303,8.303-8.303h16.605
		c4.586,0,8.303,3.716,8.303,8.303C423.715,462.342,419.998,466.058,415.412,466.058z"
        />
        <path
          style={{ fill: '#FFFFFF' }}
          d="M465.782,432.848h-16.605c-4.586,0-8.303-3.716-8.303-8.303c0-4.586,3.716-8.303,8.303-8.303h16.605
		c4.586,0,8.303,3.716,8.303,8.303C474.084,429.131,470.368,432.848,465.782,432.848z"
        />
        <path
          style={{ fill: '#FFFFFF' }}
          d="M365.042,399.637h-16.605c-4.586,0-8.303-3.716-8.303-8.303c0-4.586,3.716-8.303,8.303-8.303h16.605
		c4.586,0,8.303,3.716,8.303,8.303C373.345,395.92,369.629,399.637,365.042,399.637z"
        />
        <path
          style={{ fill: '#FFFFFF' }}
          d="M62.824,399.637H46.218c-4.586,0-8.303-3.716-8.303-8.303c0-4.586,3.716-8.303,8.303-8.303h16.605
		c4.586,0,8.303,3.716,8.303,8.303C71.126,395.92,67.41,399.637,62.824,399.637z"
        />
      </g>
      <path
        style={{ fill: '#95AC66' }}
        d="M332.322,52.247c-10.985-10.985-25.58-17.034-41.097-17.034c-7.906,0-15.569,1.578-22.642,4.571
	...
	s4.25-0.81,5.872-2.431C335.564,60.747,335.564,55.491,332.322,52.247z"
      ...
      <path
        style={{ fill: '#AAC36D' }}
        d="M206.184,0c-4.586,0-8.303,3.716-8.303,8.303s3.716,8.303,8.303,8.303
...
interface SwapiCardsRockyIslandProps {
  homeworld: string;
  terrain: string;
}

const SwapiCardsRockyIsland: React.FC<SwapiCardsRockyIslandProps> = ({
  homeworld,
  terrain,
}) => {
  return (
...
export default SwapiCardsRockyIsland;
