interface SwapiCardsMountainTwoProps {
  className?: string;
  color: string;
}

const SwapiCardsMountainTwo: React.FC<SwapiCardsMountainTwoProps> = ({
  className,
  color,
}) => (
  <>
    <defs>
      ...
      >
        ...
        <stop offset="5%" stopColor={color} stopOpacity="0.99" />
...
export default SwapiCardsMountainTwo;
