...
const servicesData = [
  {
    id: 'ai-integration',
    icon: <SiOpenai className="text-5xl mx-auto" />,
  ...
  },
  {
    ...
    icon: <FaCode className="text-5xl mx-auto" />,
  ...
  },
  {
    ...
    icon: <FaWordpress className="text-5xl mx-auto" />,
  ...
  },
  {
    ...
    icon: <MdOutlineDesignServices className="text-5xl mx-auto" />,
  ...
  {
    id: 'api-development',
    icon: <FaConnectdevelop className="text-5xl mx-auto" />,
  ...
  },
  {
    ...
    icon: <MdSpeed className="text-5xl mx-auto" />,
