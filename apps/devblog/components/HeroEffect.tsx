...
export const HeroEffect = ({
  ...
  return (
    <div className={cn('sticky top-48 md:top-64', className)}>
      <p className="text-lg md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300 dark:from-neutral-200 dark:to-neutral-400">
      ...
      <p className="text-xs md:text-xl font-normal text-center text-neutral-600 dark:text-neutral-400 mt-4 max-w-lg mx-auto">
        {description ? (
          ...
          <span className="text-xl mb-8 max-w-md">
      ...
      <svg
        ...
        className="absolute -top-[12rem] md:-top-40 w-full"
      >
        <motion.path
