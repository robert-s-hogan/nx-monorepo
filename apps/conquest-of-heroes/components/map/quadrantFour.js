...
const QuadrantFour = ({ objects, structures }) => {
  ...
  return (
    <>
      ...
      <Box position="absolute" top="5" left="5" right="5" bottom="5">
        {randomItemOne && <Text fontSize="xs">{objects[randomItemOne].name}</Text>}
        {randomStructureOne && (
          <FontAwesomeIcon
      ...
      <Box position="absolute" left="5" right="5" bottom="5">
        {randomItemTwo && <Text fontSize="xs">{objects[randomItemTwo].name}</Text>}
        {randomStructureTwo && (
          <FontAwesomeIcon
      ...
      <Box position="absolute" right="5">
        {randomItemThree && <Text fontSize="xs">{objects[randomItemThree].name}</Text>}
      ...
      <Box position="absolute" left="5">
        {randomItemFour && <Text fontSize="xs">{objects[randomItemFour].name}</Text>}
        {randomStructureFour && (
          <FontAwesomeIcon
